...
const ELO_RATING_FIFA = {
    ...
    'CAN': emphasizeRecentCoeff(1767, 1784),
    ...
    'BIH': emphasizeRecentCoeff(1616, 1594),
...
const SCENARIO_FIFA_2026 = {
    ...
    scenario: [
        ...
        { type: 'group', label: 'B', params: {members: ['CAN', 'BIH', 'QAT', 'SUI'], matches: { 'CAN-BIH': '1:1', 'QAT-SUI': '', 'SUI-BIH': '', 'CAN-QAT': '', 'SUI-CAN': '', 'BIH-QAT': '' } } },
        { type: 'group', label: 'C', params: {members: ['BRA', 'MAR', 'HAI', 'SCO'], matches: { 'BRA-MAR': '', 'HAI-SCO': '', 'SCO-MAR': '', 'BRA-HAI': '', 'SCO-BRA': '', 'MAR-HAI': '' } } },
        { type: 'group', label: 'D', params: {members: ['USA', 'PAR', 'AUS', 'TUR'], matches: { 'USA-PAR': '4:1', 'AUS-TUR': '', 'USA-AUS': '', 'TUR-PAR': '', 'TUR-USA': '', 'PAR-AUS': '' } } },
