...
const ELO_RATING_FIFA = {
    ...
    'BRA': emphasizeRecentCoeff(1986, 1984),
    ...
    'MAR': emphasizeRecentCoeff(1866, 1822),
    'CAN': emphasizeRecentCoeff(1777, 1784),
    'AUS': emphasizeRecentCoeff(1799, 1783),
    'SCO': emphasizeRecentCoeff(1768, 1767),
    ...
    'HAI': emphasizeRecentCoeff(1528, 1532),
...
const SCENARIO_FIFA_2026 = {
    ...
    scenario: [
        ...
        { type: 'group', label: 'C', params: {members: ['BRA', 'MAR', 'HAI', 'SCO'], matches: { 'BRA-MAR': '1:1', 'HAI-SCO': '0:1', 'SCO-MAR': '0:1', 'BRA-HAI': '3:0', 'SCO-BRA': '', 'MAR-HAI': '' } } },
