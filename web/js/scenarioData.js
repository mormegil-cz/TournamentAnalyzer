...
const ELO_RATING_FIFA = {
    'ESP': emphasizeRecentCoeff(2157, 2165),
    'ARG': emphasizeRecentCoeff(2115, 2113),
    'FRA': emphasizeRecentCoeff(2063, 2081),
    'ENG': emphasizeRecentCoeff(2024, 2020),
    'POR': emphasizeRecentCoeff(1989, 1984),
    'BRA': emphasizeRecentCoeff(1991, 1984),
    'COL': emphasizeRecentCoeff(1982, 1975),
    'NED': emphasizeRecentCoeff(1948, 1961),
    'ECU': emphasizeRecentCoeff(1938, 1933),
    'CRO': emphasizeRecentCoeff(1912, 1930),
    'GER': emphasizeRecentCoeff(1932, 1923),
    'NOR': emphasizeRecentCoeff(1914, 1912),
    'JPN': emphasizeRecentCoeff(1906, 1904),
    'TUR': emphasizeRecentCoeff(1911, 1902),
    'URU': emphasizeRecentCoeff(1892, 1892),
    'SUI': emphasizeRecentCoeff(1891, 1889),
    'SEN': emphasizeRecentCoeff(1860, 1878),
    'BEL': emphasizeRecentCoeff(1894, 1867),
    'MEX': emphasizeRecentCoeff(1875, 1860),
    'PAR': emphasizeRecentCoeff(1834, 1833),
    'AUT': emphasizeRecentCoeff(1830, 1827),
    'MAR': emphasizeRecentCoeff(1827, 1822),
    'CAN': emphasizeRecentCoeff(1788, 1784),
    'AUS': emphasizeRecentCoeff(1777, 1783),
    'SCO': emphasizeRecentCoeff(1782, 1767),
    'IRN': emphasizeRecentCoeff(1772, 1760),
    'KOR': emphasizeRecentCoeff(1758, 1752),
    'ALG': emphasizeRecentCoeff(1772, 1743),
    'PAN': emphasizeRecentCoeff(1730, 1737),
    'UZB': emphasizeRecentCoeff(1714, 1727),
    'CZE': emphasizeRecentCoeff(1740, 1726),
    'USA': emphasizeRecentCoeff(1726, 1721),
    'SWE': emphasizeRecentCoeff(1712, 1719),
    'JOR': emphasizeRecentCoeff(1680, 1690),
    'EGY': emphasizeRecentCoeff(1696, 1689),
    'CIV': emphasizeRecentCoeff(1695, 1676),
    'COD': emphasizeRecentCoeff(1652, 1655),
    'TUN': emphasizeRecentCoeff(1628, 1636),
    'IRQ': emphasizeRecentCoeff(1607, 1607),
    'BIH': emphasizeRecentCoeff(1595, 1594),
    'NZL': emphasizeRecentCoeff(1562, 1585),
    'KSA': emphasizeRecentCoeff(1576, 1568),
    'CPV': emphasizeRecentCoeff(1578, 1549),
    'HAI': emphasizeRecentCoeff(1548, 1532),
    'RSA': emphasizeRecentCoeff(1517, 1524),
    'GHA': emphasizeRecentCoeff(1510, 1503),
    'CUW': emphasizeRecentCoeff(1434, 1436),
    'QAT': emphasizeRecentCoeff(1421, 1425),
};
...
const SCENARIO_FIFA_2026 = {
    rules: RULES.FIFA,
    scenario: [
        { type: 'group', label: 'A', params: {members: ['MEX', 'RSA', 'KOR', 'CZE'], matches: { 'MEX-RSA': '', 'KOR-CZE': '', 'CZE-RSA': '', 'MEX-KOR': '', 'CZE-MEX': '', 'RSA-KOR': '' } } },
        { type: 'group', label: 'B', params: {members: ['CAN', 'BIH', 'QAT', 'SUI'], matches: { 'CAN-BIH': '', 'QAT-SUI': '', 'SUI-BIH': '', 'CAN-QAT': '', 'SUI-CAN': '', 'BIH-QAT': '' } } },
        { type: 'group', label: 'C', params: {members: ['BRA', 'MAR', 'HAI', 'SCO'], matches: { 'BRA-MAR': '', 'HAI-SCO': '', 'SCO-MAR': '', 'BRA-HAI': '', 'SCO-BRA': '', 'MAR-HAI': '' } } },
        { type: 'group', label: 'D', params: {members: ['USA', 'PAR', 'AUS', 'TUR'], matches: { 'USA-PAR': '', 'AUS-TUR': '', 'USA-AUS': '', 'TUR-PAR': '', 'TUR-USA': '', 'PAR-AUS': '' } } },
        { type: 'group', label: 'E', params: {members: ['GER', 'CUW', 'CIV', 'ECU'], matches: { 'GER-CUW': '', 'CIV-ECU': '', 'GER-CIV': '', 'ECU-CUW': '', 'CUW-CIV': '', 'ECU-GER': '' } } },
        { type: 'group', label: 'F', params: {members: ['NED', 'JPN', 'SWE', 'TUN'], matches: { 'NED-JPN': '', 'SWE-TUN': '', 'NED-SWE': '', 'TUN-JPN': '', 'JPN-SWE': '', 'TUN-NED': '' } } },
        { type: 'group', label: 'G', params: {members: ['BEL', 'EGY', 'IRN', 'NZL'], matches: { 'BEL-EGY': '', 'IRN-NZL': '', 'BEL-IRN': '', 'NZL-EGY': '', 'EGY-IRN': '', 'NZL-BEL': '' } } },
        { type: 'group', label: 'H', params: {members: ['ESP', 'CPV', 'KSA', 'URU'], matches: { 'ESP-CPV': '', 'KSA-URU': '', 'ESP-KSA': '', 'URU-CPV': '', 'CPV-KSA': '', 'URU-ESP': '' } } },
        { type: 'group', label: 'I', params: {members: ['FRA', 'SEN', 'IRQ', 'NOR'], matches: { 'FRA-SEN': '', 'IRQ-NOR': '', 'FRA-IRQ': '', 'NOR-SEN': '', 'NOR-FRA': '', 'SEN-IRQ': '' } } },
        { type: 'group', label: 'J', params: {members: ['ARG', 'ALG', 'AUT', 'JOR'], matches: { 'ARG-ALG': '', 'AUT-JOR': '', 'ARG-AUT': '', 'JOR-ALG': '', 'ALG-AUT': '', 'JOR-ARG': '' } } },
        { type: 'group', label: 'K', params: {members: ['POR', 'COD', 'UZB', 'COL'], matches: { 'POR-COD': '', 'UZB-COL': '', 'POR-UZB': '', 'COL-COD': '', 'COL-POR': '', 'COD-UZB': '' } } },
        { type: 'group', label: 'L', params: {members: ['ENG', 'CRO', 'GHA', 'PAN'], matches: { 'ENG-CRO': '', 'GHA-PAN': '', 'ENG-GHA': '', 'PAN-CRO': '', 'PAN-ENG': '', 'CRO-GHA': '' } } },
