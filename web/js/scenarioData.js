...
const ELO_RATING_FIFA = {
    'ESP': emphasizeRecentCoeff(2134, 2165),
    'ARG': emphasizeRecentCoeff(2144, 2113),
    'FRA': emphasizeRecentCoeff(2090, 2081),
    'ENG': emphasizeRecentCoeff(2028, 2020),
    'POR': emphasizeRecentCoeff(1988, 1984),
    'BRA': emphasizeRecentCoeff(2009, 1984),
    'COL': emphasizeRecentCoeff(2006, 1975),
    'NED': emphasizeRecentCoeff(1972, 1961),
    'ECU': emphasizeRecentCoeff(1864, 1933),
    'CRO': emphasizeRecentCoeff(1896, 1930),
    'GER': emphasizeRecentCoeff(1954, 1923),
    'NOR': emphasizeRecentCoeff(1951, 1912),
    'JPN': emphasizeRecentCoeff(1925, 1904),
    'TUR': emphasizeRecentCoeff(1813, 1902),
    'URU': emphasizeRecentCoeff(1851, 1892),
    'SUI': emphasizeRecentCoeff(1914, 1889),
    'SEN': emphasizeRecentCoeff(1817, 1878),
    'BEL': emphasizeRecentCoeff(1869, 1867),
    'MEX': emphasizeRecentCoeff(1912, 1860),
    'PAR': emphasizeRecentCoeff(1816, 1833),
    'AUT': emphasizeRecentCoeff(1841, 1827),
    'MAR': emphasizeRecentCoeff(1877, 1822),
    'CAN': emphasizeRecentCoeff(1748, 1784),
    'AUS': emphasizeRecentCoeff(1799, 1783),
    'SCO': emphasizeRecentCoeff(1745, 1767),
    'IRN': emphasizeRecentCoeff(1766, 1760),
    'KOR': emphasizeRecentCoeff(1723, 1752),
    'ALG': emphasizeRecentCoeff(1780, 1743),
    'PAN': emphasizeRecentCoeff(1668, 1737),
    'UZB': emphasizeRecentCoeff(1677, 1727),
    'CZE': emphasizeRecentCoeff(1680, 1726),
    'USA': emphasizeRecentCoeff(1820, 1721),
    'SWE': emphasizeRecentCoeff(1727, 1719),
    'JOR': emphasizeRecentCoeff(1632, 1690),
    'EGY': emphasizeRecentCoeff(1740, 1689),
    'CIV': emphasizeRecentCoeff(1728, 1676),
    'COD': emphasizeRecentCoeff(1666, 1655),
    'TUN': emphasizeRecentCoeff(1570, 1636),
    'IRQ': emphasizeRecentCoeff(1586, 1607),
    'BIH': emphasizeRecentCoeff(1622, 1594),
    'NZL': emphasizeRecentCoeff(1549, 1585),
    'KSA': emphasizeRecentCoeff(1593, 1568),
    'CPV': emphasizeRecentCoeff(1625, 1549),
    'HAI': emphasizeRecentCoeff(1517, 1532),
    'RSA': emphasizeRecentCoeff(1575, 1524),
    'GHA': emphasizeRecentCoeff(1584, 1503),
    'CUW': emphasizeRecentCoeff(1453, 1436),
    'QAT': emphasizeRecentCoeff(1411, 1425),
};
...
const SCENARIO_FIFA_2026 = {
    rules: RULES.FIFA,
    scenario: [
        { type: 'group', label: 'A', params: {members: ['MEX', 'RSA', 'KOR', 'CZE'], matches: { 'MEX-RSA': '2:0', 'KOR-CZE': '2:1', 'CZE-RSA': '1:1', 'MEX-KOR': '1:0', 'CZE-MEX': '0:3', 'RSA-KOR': '1:0' } } },
        { type: 'group', label: 'B', params: {members: ['CAN', 'BIH', 'QAT', 'SUI'], matches: { 'CAN-BIH': '1:1', 'QAT-SUI': '1:1', 'SUI-BIH': '4:1', 'CAN-QAT': '6:0', 'SUI-CAN': '2:1', 'BIH-QAT': '3:1' } } },
        { type: 'group', label: 'C', params: {members: ['BRA', 'MAR', 'HAI', 'SCO'], matches: { 'BRA-MAR': '1:1', 'HAI-SCO': '0:1', 'SCO-MAR': '0:1', 'BRA-HAI': '3:0', 'SCO-BRA': '0:3', 'MAR-HAI': '4:2' } } },
        { type: 'group', label: 'D', params: {members: ['USA', 'PAR', 'AUS', 'TUR'], matches: { 'USA-PAR': '4:1', 'AUS-TUR': '2:0', 'USA-AUS': '2:0', 'TUR-PAR': '0:1', 'TUR-USA': '', 'PAR-AUS': '' } } },
        { type: 'group', label: 'E', params: {members: ['GER', 'CUW', 'CIV', 'ECU'], matches: { 'GER-CUW': '7:1', 'CIV-ECU': '1:0', 'GER-CIV': '2:1', 'ECU-CUW': '0:0', 'CUW-CIV': '', 'ECU-GER': '' } } },
        { type: 'group', label: 'F', params: {members: ['NED', 'JPN', 'SWE', 'TUN'], matches: { 'NED-JPN': '2:2', 'SWE-TUN': '5:1', 'NED-SWE': '5:1', 'TUN-JPN': '0:4', 'JPN-SWE': '', 'TUN-NED': '' } } },
        { type: 'group', label: 'G', params: {members: ['BEL', 'EGY', 'IRN', 'NZL'], matches: { 'BEL-EGY': '1:1', 'IRN-NZL': '2:2', 'BEL-IRN': '0:0', 'NZL-EGY': '1:3', 'EGY-IRN': '', 'NZL-BEL': '' } } },
        { type: 'group', label: 'H', params: {members: ['ESP', 'CPV', 'KSA', 'URU'], matches: { 'ESP-CPV': '0:0', 'KSA-URU': '1:1', 'ESP-KSA': '4:0', 'URU-CPV': '2:2', 'CPV-KSA': '', 'URU-ESP': '' } } },
        { type: 'group', label: 'I', params: {members: ['FRA', 'SEN', 'IRQ', 'NOR'], matches: { 'FRA-SEN': '3:1', 'IRQ-NOR': '1:4', 'FRA-IRQ': '3:0', 'NOR-SEN': '3:2', 'NOR-FRA': '', 'SEN-IRQ': '' } } },
        { type: 'group', label: 'J', params: {members: ['ARG', 'ALG', 'AUT', 'JOR'], matches: { 'ARG-ALG': '3:0', 'AUT-JOR': '3:1', 'ARG-AUT': '2:0', 'JOR-ALG': '1:2', 'ALG-AUT': '', 'JOR-ARG': '' } } },
        { type: 'group', label: 'K', params: {members: ['POR', 'COD', 'UZB', 'COL'], matches: { 'POR-COD': '1:1', 'UZB-COL': '1:3', 'POR-UZB': '5:0', 'COL-COD': '1:0', 'COL-POR': '', 'COD-UZB': '' } } },
        { type: 'group', label: 'L', params: {members: ['ENG', 'CRO', 'GHA', 'PAN'], matches: { 'ENG-CRO': '4:2', 'GHA-PAN': '1:0', 'ENG-GHA': '0:0', 'PAN-CRO': '0:1', 'PAN-ENG': '', 'CRO-GHA': '' } } },
