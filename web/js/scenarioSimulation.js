(function () {
    ...
    const ELO_RATING_FIFA = {
        ...
        CRO: 1952, // 1936, // 1945, // 1945, // 1914, // 1922,
    ...
    function runSimulationMain() {
        ...
        scenario = [
            ...
            */
            ...
            new PlayoffTree('_result', ['A#1', 'B#2', 'C#1', 'D#2', 'E#1', 'F#2', 'G#1', 'H#2', 'B#1', 'A#2', 'D#1', 'C#2', 'F#1', 'E#2', 'H#1', 'G#2'], RULES.FIFA, preparePresetMatches({ 'NED-USA': '3:1', 'ARG-AUS': '2:1', 'FRA-POL': '3:1', 'JPN-CRO': '1:2o', 'BRA-KOR': '4:1', 'ENG-SEN': '3:0', 'MAR-ESP': '1:0o', 'POR-SUI': '6:1', 'BRA-CRO': '1:2o' }))
        ];
