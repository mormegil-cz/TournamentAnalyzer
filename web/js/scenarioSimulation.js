...
function runSimulationMain(iterations) {
    ...
    const scenario = [
        ...
        */
        ...
        new Group('E', ["ESP", "CRC", "GER", "JPN"], preparePresetMatches({ 'GER-JPN': '1:2', 'ESP-CRC': '', 'JPN-CRC': '', 'ESP-GER': '', 'JPN-ESP': '', 'CRC-GER': '' }), RULES.FIFA),
        new Group('F', ["BEL", "CAN", "MAR", "CRO"], preparePresetMatches({ 'MAR-CRO': '0:0', 'BEL-CAN': '', 'BEL-MAR': '', 'CRO-CAN': '', 'CRO-BEL': '', 'CAN-MAR': '' }), RULES.FIFA),
