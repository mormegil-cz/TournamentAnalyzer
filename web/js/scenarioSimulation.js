(function () {
    ...
    const ELO_RATING_FIFA = {
        ...
        ARG: 2120, // 2125, // 2118, // 2101, // 2086, // 2141,
        ESP: 1996, // 2007, // 2056, // 2068, // 2045,
        NED: 2073, // 2068, // 2047, // 2036, // 2050, // 2040,
        FRA: 2046, // 2018, // 1993, // 2046, // 2022, // 2005,
        ...
        MAR: 1925, // 1882, // 1871, // 1851, // 1779, // 1753,
    ...
    function runSimulationMain() {
        ...
        scenario = [
            ...
            */
            ...
            new PlayoffTree('_result', ['A#1', 'B#2', 'C#1', 'D#2', 'E#1', 'F#2', 'G#1', 'H#2', 'B#1', 'A#2', 'D#1', 'C#2', 'F#1', 'E#2', 'H#1', 'G#2'], RULES.FIFA, preparePresetMatches({ 'NED-USA': '3:1', 'ARG-AUS': '2:1', 'FRA-POL': '3:1', 'JPN-CRO': '1:2o', 'BRA-KOR': '4:1', 'ENG-SEN': '3:0', 'MAR-ESP': '1:0o', 'POR-SUI': '6:1', 'CRO-BRA': '2:1o', 'NED-ARG': '2:3o', 'MAR-POR': '1:0', 'ENG-FRA': '1:2' }))
        ];
