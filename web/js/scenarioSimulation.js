(function () {
    ...
    const ELO_RATING_FIFA = {
        ...
        JPN: 1841, // 1792, // 1831, // 1798,
        WAL: 1717, // 1742, // 1791, // 1790,
        KOR: 1801, // 1750, // 1798, // 1786,
    ...
    function runSimulationMain() {
        ...
        scenario = [
            ...
            */
            ...
            new PlayoffTree('_result', ['A#1', 'B#2', 'C#1', 'D#2', 'E#1', 'F#2', 'G#1', 'H#2', 'B#1', 'A#2', 'D#1', 'C#2', 'F#1', 'E#2', 'H#1', 'G#2'], RULES.FIFA, preparePresetMatches({ 'NED-USA': '3:1', 'ARG-AUS': '2:1', 'FRA-POL': '3:1', 'ENG-SEN': '3:0', 'MAR-ESP': '1:0o' }))
        ];
