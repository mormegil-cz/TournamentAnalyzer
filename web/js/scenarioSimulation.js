(function () {
    ...
    const ELO_RATING_FIFA = {
        BRA: 2150, // 2137, // 2195, // 2185, // 2169,
        ARG: 2125, // 2118, // 2101, // 2086, // 2141,
        ESP: 1996, // 2007, // 2056, // 2068, // 2045,
        NED: 2068, // 2047, // 2036, // 2050, // 2040,
        FRA: 2018, // 1993, // 2046, // 2022, // 2005,
        BEL: 1948, // 1948, // 2020, // 2007,
        POR: 1993, // 2044, // 2010, // 2006,
        DEN: 1883, // 1928, // 1952, // 1971,
        GER: 1956, // 1931, // 1919, // 1960,
        URU: 1905, // 1890, // 1924, // 1936,
        SUI: 1928, // 1901, // 1911, // 1902,
        CRO: 1936, // 1945, // 1945, // 1914, // 1922,
        ENG: 1995, // 1969, // 1944, // 1957, // 1920,
    ...
    function runSimulationMain() {
        ...
        scenario = [
            ...
            */
            ...
            new PlayoffTree('_result', ['A#1', 'B#2', 'C#1', 'D#2', 'E#1', 'F#2', 'G#1', 'H#2', 'B#1', 'A#2', 'D#1', 'C#2', 'F#1', 'E#2', 'H#1', 'G#2'], RULES.FIFA, preparePresetMatches({ 'NED-USA': '3:1', 'ARG-AUS': '2:1', 'FRA-POL': '3:1', 'JPN-CRO': '1:2o', 'BRA-KOR': '4:1', 'ENG-SEN': '3:0', 'MAR-ESP': '1:0o' }))
        ];
